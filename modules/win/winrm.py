...
args,
    ...
    if windows:
        ...
        print(
            f"{G}[+] {W}WinRM Double-Hop Workaround\n"
        )

        print(
            f"{W}# PowerView failing from Evil-WinRM?{W}"
        )
        ...
        print(
            f"{Y}Get-DomainUser -Credential $Cred{W}"
        )

        print(
            f"{Y}Get-DomainGroup -Credential $Cred{W}"
        )

        print(
            f"{Y}Get-DomainComputer -Credential $Cred{W}"
        )
